...
every :day, at: '12:00 pm' do
	command "/usr/bin/smartmachine grids mysql flushlogs"
end

# Create daily backup.
# This also flushes the logs before backup
every :day, at: '12:00 am' do
	command "/usr/bin/smartmachine grids mysql backup --daily"
end
...
every :monday, at: '3:00 am' do
	command "/usr/bin/smartmachine grids mysql backup --promote-to-weekly"
end
